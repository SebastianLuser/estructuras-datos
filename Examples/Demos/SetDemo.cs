    ...
    public static class SetDemo
    {
        ...
        private static void RunBasicSetDemo()
        {
            ...
            foreach (int num in numbers)
            {
                ...
                numberSet.Add(num);
                Console.WriteLine($"   {(added ? "ok" : "alerta")} Intentando agregar: {num} {(added ? "" : "(ya existe)")}");
        ...
        private static void RunStringSetDemo()
        {
            ...
            foreach (string fruit in fruits)
            {
                ...
                Console.WriteLine($"   {(added ? "ok" : "alerta")} {fruit} - {status}");
            }
        ...
        {
            Console.Clear();
            Console.WriteLine(" DEMO OPERACIONES DE CONJUNTOS");
            Console.WriteLine("═══════════════════════════════════");
        ...
        private static void RunStudentListDemo()
        {
            ...
            foreach (string student in inscriptions)
            {
                ...
                Console.WriteLine($"   {(wasNew ? "ok" : "alerta")} {student} {(wasNew ? "inscrito" : "ya estaba inscrito")}");
            }
            ...
            foreach (string student in attendance)
            {
                ...
                Console.WriteLine($"   {(isEnrolled ? "ok" : "question")} {student} {(isEnrolled ? "asistió" : "asistió (no inscrito)")}");
            }
        ...
        {
            Console.Clear();
            Console.WriteLine(" DEMO TAGS Y CATEGORÍAS");
            Console.WriteLine("═══════════════════════════");
        ...
        private static void AddElementInteractive(DynamicSet<string> set)
        {
            ...
            if (!string.IsNullOrWhiteSpace(element))
            {
                ...
                set.Add(element);
                Console.WriteLine($"{(wasNew ? "ok" : "alert")} '{element}' {(wasNew ? "agregado correctamente" : "ya existía en el conjunto")}");
            }
            else
            {
